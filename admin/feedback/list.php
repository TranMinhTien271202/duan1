                    ...
                    <table class="content__table-table">
                        ...
                        <tbody class="content__table-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($item['status']): ?>
                                    <span class="content__table-stt-active">Đã phản hồi</span>
                                    <?php else: ?>
                                    <span class="content__table-stt-locked">Chưa xem</span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <div class="user_list-action">
                                        ...
                                        <a href="<?=$ADMIN_URL . '/feedback/?detail&id=' . $item['id'];?>" class="content__table-action info">
